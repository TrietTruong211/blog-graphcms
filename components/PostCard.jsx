    ...
    <div className="mb-8 rounded-lg bg-white p-0 pb-12 shadow-lg lg:p-8">
      ...
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="trasition inline-block transform cursor-pointer rounded-full bg-pink-600 px-8 py-3 font-medium text-white duration-500 hover:-translate-y-1">
            Continue reading
          </span>
        </Link>
      </div>
